            ...
            while(!done){
                ...
                if (message.contains("GET")){
                    try{
                        ...
                        IHistoryRMI history = (IHistoryRMI) registry.lookup("history");
                    ...
                    IHistory historytxt = new HistoryChatByDB(); // Use the instance to instantiate HistoryChatByTxt
                    FileDB fileDB = new FileDB(message, historytxt); // Use the instance to instantiate FileDB
                    fileDB.write();
                }else{
                    done = true;
